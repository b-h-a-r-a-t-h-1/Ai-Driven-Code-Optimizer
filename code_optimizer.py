...
class SystemManager:
    ...
    def generate_full_report(self):
        report = ""
        # Removed "Detected Language" output as requested.
...
@app.route("/")
def index():
    # A creative UI using Google Fonts and a modern gradient background.
    html = '''<!doctype html>
<html>
<head>
...
def analyze():
    ...
    # We remove the "Detected Language:" output per requirements.
